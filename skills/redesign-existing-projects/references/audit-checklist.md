...
## Shared aesthetic rules → `anti-slop-frontend` (one source of truth)

The core "does this look AI-generated" tells are the same whether you build new or fix existing, so they live once in the [`anti-slop-frontend`](../../anti-slop-frontend/SKILL.md) skill — apply those first:
